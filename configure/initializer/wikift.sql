...
INSERT INTO `wikift_role`(`code`, `name`, `description`)
...
CREATE TABLE `wikift_user_role_relation`
(
    `user_id` BIGINT(20),
    `role_id` BIGINT(20)
) COMMENT '用户与路由关系表';

CREATE TABLE `wikift_article`
(
    `id`          BIGINT(20) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `wikift_user_article_relation`
(
    `user_id` BIGINT(20),
